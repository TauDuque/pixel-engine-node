...
import { HexagonalTaskController } from "../infrastructure/controllers/HexagonalTaskController";
import { ValidationMiddleware } from "../middleware/validation";
import { uploadSingle } from "../middleware/upload";

const router = Router();
const hexagonalController = new HexagonalTaskController();
...
router.post(
  ...
  hexagonalController.createTask.bind(hexagonalController)
);
...
router.get(
  ...
  hexagonalController.getTask.bind(hexagonalController)
);
